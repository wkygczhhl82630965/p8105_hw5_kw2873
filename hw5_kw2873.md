...
the test) on the y axis and the true value of β2 on the x axis.
...
interpretation: As we can see that the line indicates a positive
correlation, we can see that the larger of effect size, the power
increases along.
